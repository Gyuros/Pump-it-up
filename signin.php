	  ...
	  $( document ).ready(function() {
		...
		if(Ok){
			...
			.done(function( result ) {
				if (result=="success") {
					alertify.minimalDialog("Sikeres regisztráció!<br>Mostmár bejelentkezhetsz!");
					ShowLogin();
				}
				
				if(result=="exist"){
					alertify.minimalDialog("Ez az E-mail cím már foglalt!");
				}
			});
		}
	  });
		...
		function SignIn(em,pw){
			$( document ).ready(function() {
				...
				if(Ok){
					...
					.done(function( result ) {
						if (result=="success") {
							alertify.minimalDialog("Sikeres bejelentkezés");
							window.location="profile.php";
						}
						if (result=="wrong_login") {
							alertify.minimalDialog("Sikertelen bejelentkezés");
						}
					});
				}
			});
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<?php
								if($_SESSION['is_trainer'] && $_SESSION['is_trainer']){
								...
								if($_SESSION['id']!=""){
									...
									echo "<li  class='active'><a href='signin.php'>Belépés</a></li>";
								}
							?>
						</ul>
					</div>
				...
				<ul class="slides">
			   	<li style="background-image: url(images/img_bg_3.jpg);">
			   		...
			   		<div class="container-fluids">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-xs-12 col-sm-8 col-sm-offset-2 slider-text slider-text-bg">
